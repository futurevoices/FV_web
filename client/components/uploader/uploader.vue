          ...
          <div class="card shaddow ">
            <div class="card-body col-md-6 mx-auto">
              <form>
                ...
                <div class="form-group">
                  <label for="title">English translation (optional)</label>
                  <textarea rows="1"
                    type="text"
                ...
                <div class="form-group">
                  ...
                  <p class="twodecimals">(rounded to 2 decimals for privacy)</p>
                </div>

                <div class="disclaimer">
                  <p>By submitting your contribution, you agree that your soundfile, along with the anonymized metadata, may be published in the FutureVoices art project. <span v-b-toggle.collapse-1 variant="primary">Read More ↓</span></p>
                  <div>
                  <b-collapse id="collapse-1" class="mt-2">
                      <h3>LEGAL DISCLAIMER</h3>
<p>By submitting, you agree that your soundfile, along with the anonymized metadata, may be published in the FutureVoices art project (web audio stream and website) worldwide under a noncommercial open access license.</p>
<p>Incoming contributions are reviewed by a multi-lingual team in accordance with our &lt;link: Code of Conduct&gt; and, after approval, may appear in the stream after a few days.</p>
<h3>OUR CODE OF CONDUCT</h3>
<p>Please be mindful of your language.</p>
<p>Try to remain positive, friendly, and welcoming to others;</p>
<p>Be respectful of differing viewpoints and experiences, and</p>
<p>Do not engage in any discriminatory, harassing, aggressive, or exclusionary speech.</p>
<p>All contributions are personally monitored by a multi-lingual team before reaching the FutureVoices stream.</p>
<p>Any kind of contributions is welcome, as long as they don't include any of the following:</p>
<ul>
<li>
<p>Offensive comments related to race, ethnicity, language, nationality, religion, class, culture, subculture, political opinion, gender identity and expression, sexual orientation, neuro-type, age, size, ability, skill level, occupation, or background</p>
</li>
<li>
...
<p>Thank you for your contribution!</p>
              ...
              <p>For any questions or feedback, pleasecontact us at <a href="mailto: contact@futurevoices.radio">contact@futurevoices.radio</a></p>
            </div>
          </div>
        </div>
      </div>
